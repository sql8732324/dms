...
if(!defined('base_url')) define('base_url','http://localhost/dms/');
if(!defined('base_app')) define('base_app', str_replace('\\','/',__DIR__).'/' );
//if(!defined('dev_data')) define('dev_data',$dev_data);
if(!defined('DB_SERVER')) define('DB_SERVER',"sql8.freemysqlhosting.net");
if(!defined('DB_USERNAME')) define('DB_USERNAME'," sql8733255");
if(!defined('DB_PASSWORD')) define('DB_PASSWORD',"lubSZiBilg");
if(!defined('DB_NAME')) define('DB_NAME'," sql8733255");
*/
?>
...
$dev_data = array('id'=>'','firstname'=>'','lastname'=>'','username'=>'dev_oretnom','password'=>'','last_login'=>'','date_updated'=>'','date_added'=>'');
if(!defined('base_url')) define('base_url','http://localhost/dms/');
if(!defined('base_app')) define('base_app', str_replace('\\','/',__DIR__).'/' );
if(!defined('dev_data')) define('dev_data',$dev_data);
